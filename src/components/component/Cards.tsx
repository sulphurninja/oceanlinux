...
const Dashboard = () => {
    ...
    return (
        <div className="flex flex-col overflow-hidden">
            <main className="flex-1 p-4 md:p-8">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <Card className="shadow-md bg-transparent border dark:border-none-gray-800">
                        <CardHeader>
                            <div className="flex items-center gap-2">
                ...
                {error && (
                    <div className="mt-4 p-4 bg-red-500/10 border dark:border-none border dark:border-none-red-500/30 rounded-md text-red-400 text-sm">
                        {error}
                    </div>
                )}

                {!isLoading && !error && totalVPS === 0 && (
                    <div className="mt-8 text-center p-6 bg-gray-800/50 border dark:border-none border dark:border-none-gray-700 rounded-lg">
