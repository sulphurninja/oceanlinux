                    ...
                    <div className="max-w-4xl mx-auto space-y-12">
                            ...
                            <CardContent className="p-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 mt-8">
                                        <div className="p-6 bg-gradient-to-br from-blue-500/10 to-blue-600/5 rounded-lg morder dark:morder-none morder dark:morder-none-blue-500/20">
                                        ...
                                        <div className="p-6 bg-gradient-to-br from-green-500/10 to-green-600/5 rounded-lg morder dark:morder-none morder dark:morder-none-green-500/20">
                                            <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div className="p-4 bg-primary/5 morder dark:morder-none morder dark:morder-none-primary/20 rounded-lg">
                        ...
                        <Card>
                            <CardContent className="p-8">
                                ...
                                <div className="space-y-6">
                                    <div className="text-center p-8 bg-gradient-to-br from-green-500/5 to-blue-500/5 rounded-lg morder dark:morder-none">
                        ...
                        <Card>
                            <CardContent className="p-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="p-6 bg-gradient-to-br from-purple-500/10 to-purple-600/5 rounded-lg morder dark:morder-none morder dark:morder-none-purple-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div className="p-6 bg-gradient-to-br from-orange-500/10 to-orange-600/5 rounded-lg morder dark:morder-none morder dark:morder-none-orange-500/20">
                                        <div className="flex items-center gap-3 mb-4">
                        ...
                        <Card>
                            <CardContent className="p-8">
                                ...
                                <div className="space-y-6">
                                    <div className="text-center p-8 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 rounded-lg morder dark:morder-none">
                        ...
                        {/* Call to Action */}
                        <Card className="bg-gradient-to-br from-blue-500/5 to-purple-500/5 morder dark:morder-none-primary/20">
                        ...
                        {/* Last Updated */}
                        <div className="text-center pt-8 morder dark:morder-none-t">
                            <p className="text-sm text-muted-foreground">
