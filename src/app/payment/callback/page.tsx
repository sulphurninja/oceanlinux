...
const retried = useRef(false);
  ...
  useEffect(() => {
    // In your PaymentCallbackContent component, update the verifyPayment function:
      ...
      try {
        ...
        const response = await fetch("/api/payment/status", {
          ...
          body: JSON.stringify({
            ...
            allParams: Object.fromEntries([...searchParams.entries()]) // Send all URL params for debugging
          })
        });
